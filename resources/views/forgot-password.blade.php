<!DOCTYPE html>
    ...
    <head style="margin: 0;padding: 0;">
        ...
        <title style="margin: 0;padding: 0;">Showtalent</title>
    </head>
    <body style="margin: 0;padding: 0;font-family:Montserrat;">
        <div class="right-tab-content" style="margin: 0 auto;padding: 11px 34px;border: 1px solid #35ABA7;-webkit-border-radius: 10px;border-radius: 10px;width: 25%;position: relative;">
            <div class="shape-item" style="margin: 0;padding: 0;"></div>
                <h4 style="margin: 0;padding: 0;">Dear, {{$name}}</h4>
                <h4 style="margin: 0;padding: 0;">Here below is the password reset link, please go to the link to set your new password.</h4>
                <h5 style="margin: 0;padding: 0;color:blue;"><a href="{{$url}}">Click here</a></h5><br/>
