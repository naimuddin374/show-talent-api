...
class PostModel extends Model
{
    ...
    protected $fillable = ['user_id', 'type', 'category_id', 'page_id', 'title', 'description', 'newslink', 'video', 'image', 'status', 'reject_note', 'admin_id', 'is_editor', 'is_unread', 'points', 'created_at'];
